...
# 🔥 核心替换：植入 Grok 引擎，定向至你的专属中转网关
def call_grok(prompt): 
    # 双保险密钥抓取：如果你没建 GROK_API_KEY，它会默认拿 CLAUDE_API_KEY 顶替
    grok_key = os.environ.get("GROK_API_KEY", os.environ.get("CLAUDE_API_KEY", ""))
    # 强制补全 New API 标准聊天终点路径，绝杀 404
...
def merge_all(gpt, grok, gemini, stats, match_obj):
    ...
    return {
        ...
        # 对应变更为 Grok 输出节点
        "claude_score": grok.get("ai_score", "-"), "claude_analysis": grok.get("analysis", "阻断或解析失败"),
