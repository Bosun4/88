...
class BivariatePoissonModel:
    def predict(self, home_gf, home_ga, away_gf, away_ga):
        ...
        except Exception: home_gf = 1.3; home_ga = 1.1; away_gf = 1.1; away_ga = 1.3
...
class DixonColesModel:
    def predict(self, home_gf, home_ga, away_gf, away_ga):
        ...
        except Exception: home_gf = 1.3; away_gf = 1.1
...
class BradleyTerryModel:
    def predict(self, home_wins, home_total, away_wins, away_total):
        ...
        except Exception: hw = 5; ht = 15; aw = 5; at = 15
...
class BayesianModel:
    def predict(self, hw, hd, hl, aw, ad, al):
        ...
        except Exception: hw=5; hd=3; hl=3; aw=5; ad=3; al=3
